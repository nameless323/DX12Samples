...
TexWaves::TexWaves(HINSTANCE hInstance) : Application(hInstance)
{
}
...
LRESULT TexWaves::MsgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void TexWaves::Update(const GameTimer& timer)
{
...
void TexWaves::Draw(const GameTimer& timer)
{
...
void TexWaves::UpdateCamera(const GameTimer& timer)
{
...
void TexWaves::UpdateMaterialCBs(const GameTimer& timer)
{
...
void TexWaves::BuildShaderAndInputLayout()
{
...
void TexWaves::BuildRenderItems()
{
    ...
    _renderItemLayer[(int)RenderItem::RenderLayer::Opaque].push_back(wavesRenderItem.get());
    ...
    _renderItemLayer[(int)RenderItem::RenderLayer::Opaque].push_back(boxRenderItem.get());

    _allRenderItems.push_back(std::move(wavesRenderItem));
    _allRenderItems.push_back(std::move(gridRenderItem));
    _allRenderItems.push_back(std::move(boxRenderItem));
}
