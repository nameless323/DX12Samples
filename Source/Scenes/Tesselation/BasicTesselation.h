...
{
public:
    BasicTesselation(HINSTANCE hInstance);
    BasicTesselation(const BasicTesselation& rhs) = delete;
    BasicTesselation& operator=(const BasicTesselation& rhs) = delete;
    ~BasicTesselation() override;
    /**
...
protected:
    ...
    /**
     * \brief Build quad patch for tesselation.
     */
