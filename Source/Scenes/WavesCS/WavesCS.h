//
// Simulating waves using compute shaders.
//
...
protected:
    /**
     * \brief Creates rtv and dsv heaps with additional descriptors for sobel filter.
     */
    ...
    /**
     * \brief Updates waves using compute shader.
     */
    ...
    /**
     * \brief Build compute root signature.
     */
    void BuildWavesRootSignature();
    /**
     * \brief Build root signature for sobel filter.
     */
    ...
    /**
     * \brief Draw fullscreen quad for posteffect.
     */
