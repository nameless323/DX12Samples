...
struct GpuWavesFrameResource
{
    ...
    GpuWavesFrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount);
    
    GpuWavesFrameResource(const GpuWavesFrameResource& rhs) = delete;
    GpuWavesFrameResource& operator= (const GpuWavesFrameResource& rhs) = delete;
    ~GpuWavesFrameResource();
