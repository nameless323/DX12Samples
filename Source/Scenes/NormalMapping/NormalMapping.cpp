...
using Vertex = NormalMappingFrameResource::Vertex;
using FrameResource = NormalMappingFrameResource;
using RenderLayer = RenderItem::RenderLayer;

NormalMapping::NormalMapping(HINSTANCE hInstance) : Application(hInstance)
{
}
...
LRESULT NormalMapping::MsgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void NormalMapping::Update(const GameTimer& timer)
{
...
void NormalMapping::Draw(const GameTimer& timer)
{
...
void NormalMapping::OnMouseDown(WPARAM btnState, int x, int y)
{
    _lastMousePos.x = x;
    _lastMousePos.y = y;
...
void NormalMapping::OnMouseUp(WPARAM btnState, int x, int y)
{
    ReleaseCapture();
}

void NormalMapping::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void NormalMapping::OnKeyboardInput(const GameTimer& timer)
{
...
void NormalMapping::AnimateMaterials(const GameTimer& timer)
{
}

void NormalMapping::UpdateObjectCBs(const GameTimer& timer)
{
...
void NormalMapping::UpdateMaterialBuffer(const GameTimer& timer)
{
...
void NormalMapping::UpdateMainPassCB(const GameTimer& timer)
{
...
void NormalMapping::LoadTextures()
{
...
void NormalMapping::BuildRootSignature()
{
...
void NormalMapping::BuildDescriptorHeaps()
{
...
void NormalMapping::BuildShaderAndInputLayout()
{
    _shaders["standardVS"] = D3DUtil::CompileShader(L"Shaders\\Normalmapping.hlsl", nullptr, "vert", "vs_5_1");
    _shaders["opaquePS"] = D3DUtil::CompileShader(L"Shaders\\Normalmapping.hlsl", nullptr, "frag", "ps_5_1");
...
void NormalMapping::BuildShapeGeometry()
{
...
void NormalMapping::BuildFrameResources()
{
...
void NormalMapping::BuildMaterials()
{
...
void NormalMapping::BuildRenderItems()
{
    ...
    _renderItemLayer[(int)RenderLayer::Opaque].push_back(globeRitem.get());
...
void NormalMapping::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& renderItems)
{
