//
// Show overdraw using blending technique.
//
...
{
public:
    OverdrawBlending(HINSTANCE hInstance);
    OverdrawBlending(const OverdrawBlending& rhs) = delete;
    OverdrawBlending& operator=(const OverdrawBlending& rhs) = delete;
    ~OverdrawBlending() override;
    /**
