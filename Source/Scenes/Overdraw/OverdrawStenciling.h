//
// Show overdraw using stencil technique.
//
...
{
public:
    OverdrawStenciling(HINSTANCE hInstance);
    OverdrawStenciling(const OverdrawStenciling& rhs) = delete;
    OverdrawStenciling& operator=(const OverdrawStenciling& rhs) = delete;
    ~OverdrawStenciling() override;
    /**
